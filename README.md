...
> Note: Prefer **LicenseChain-JavaScript-SDK** for browser/isomorphic runtimes; this package is the Node.js server-oriented SDK. See [docs.licensechain.app](https://docs.licensechain.app/).
## API Base
